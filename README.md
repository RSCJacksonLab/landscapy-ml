...
- `landscapyml.core.data`: landscape record datasets and graph-regression data modules.
...
- `landscapyml.examples`: the maintained GAT and diffusion-prior GP demo models.

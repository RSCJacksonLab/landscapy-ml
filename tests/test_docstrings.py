...
# These compatibility aliases exist only on the branch predating issue #10;
# integrated dev removes them instead of retaining redundant public classes.
REMOVED_COMPATIBILITY_ALIASES = {
    "landscapyml.examples.gat_fitness.LandscapeGraphInputAdapter",
    "landscapyml.examples.gp_fitness.LandscapeNodeIndexInputAdapter",
}
...
def _public_object_names() -> list[str]:
    ...
    for path in sorted(SOURCE_ROOT.rglob("*.py")):
        ...
        for node in tree.body:
            ...
            if class_name not in REMOVED_COMPATIBILITY_ALIASES:
